...
<body class="bg-white m-0 p-0">
    ...
    <div class="w-full h-64 bg-cover bg-center relative" style="background-image: url('{{ asset('images/pengunjung1.png') }}');">
        <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <h1 class="text-white text-3xl md:text-4xl font-bold text-center">Artikel <br> Broadband Learning Center Surabaya</h1>
        </div>
    </div>

    <!-- Konten FAQ -->
    <div class="container mx-auto px-4 py-8">
       <div class="grid md:grid-cols-5 gap-6" x-data="{ tab: 'umum' }">
                    ...
                    <div x-data="{ open: null }" class="space-y-2">
                        <div class="border border-gray-200 rounded-xl">
                            <button @click="open === 1 ? open = null : open = 1" class="w-full flex justify-between items-center px-6 py-4 text-left text-gray-800 font-medium">
                                ...
                                <svg :class="{ 'rotate-180': open === 1 }" class="w-5 h-5 transition-transform" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                            </button>
                    ...
                    <div x-data="{ open: null }" class="space-y-2">
                        <div class="border border-gray-200 rounded-xl">
                            ...
                            <div x-show="open === 3" x-collapse class="px-6 pb-4 text-gray-600">
                                Pendaftaran bisa dilakukan secara online atau bisa datang langsung ke BLC melalui admin di lokasi.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border rounded-xl p-4 shadow hover:shadow-md transition">
                    <div class="flex items-center gap-3 mb-2">
                        <svg class="w-6 h-6 text-orange-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M9 16h6M3 4a1 1 0 011-1h16a1 1 0 011 1v16l-5-4H4a1 1 0 01-1-1V4z" />
                        </svg>
                ...
                <div class="bg-white border rounded-xl p-4 shadow hover:shadow-md transition">
                    <div class="flex items-center gap-3 mb-2">
                        <svg class="w-6 h-6 text-green-500" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M20.52 3.48A11.902 11.902 0 0012 0C5.37 0 0 5.37 0 12c0 2.12.55 4.15 1.6 5.97L0 24l6.26-1.64A11.94 11.94 0 0012 24c6.63 0 12-5.37 12-12 0-3.19-1.24-6.2-3.48-8.52zM12 22c-1.95 0-3.83-.54-5.49-1.56l-.39-.24-3.72.98 1-3.63-.25-.38A9.93 9.93 0 012 12c0-5.52 4.48-10 10-10s10 4.48 10 10-4.48 10-10 10zm4.69-7.63l-1.73-.49c-.23-.06-.48 0-.65.17l-.86.86a8.64 8.64 0 01-4.11-4.1l.86-.87c.17-.17.23-.42.17-.65l-.49-1.73a.52.52 0 00-.5-.37c-.27 0-.52.02-.76.05a1.64 1.64 0 00-1.4 1.4c-.36 2.14.49 4.54 2.57 6.62s4.47 2.93 6.62 2.57a1.64 1.64 0 001.4-1.4c.03-.24.05-.49.05-.76 0-.22-.15-.42-.37-.5z" />
                        </svg>
                ...
                <div class="bg-white border rounded-xl p-4 shadow hover:shadow-md transition">
                    <div class="flex items-center gap-3 mb-2">
                        <svg class="w-6 h-6 text-blue-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8m-18 8h18a2 2 0 002-2V6a2 2 0 00-2-2H3a2 2 0 00-2 2v8a2 2 0 002 2z" />
                        </svg>
