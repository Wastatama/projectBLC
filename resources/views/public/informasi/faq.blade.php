...
<aside class="md:col-span-1 space-y-6">
    ...
    <div class="bg-white rounded-xl shadow p-4">
        ...
        <ul class="space-y-2">
            ...
            <li><a href="{{ route('informasi.faq') }}" class="text-orange-500 font-bold">FAQ</a></li>
        </ul>
    </div>
</aside>
...
<div class="mt-10 rounded-xl p-6 shadow-sm text-center">
    ...
    <div class="grid md:grid-cols-3 gap-6 text-sm text-gray-700">
        <!-- FAQ / Pusat Bantuan -->
        <div class="bg-white border rounded-xl p-4 shadow hover:shadow-md transition text-center">
